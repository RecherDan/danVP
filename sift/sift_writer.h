...
namespace Sift
{
   class Writer
   {
      ...
      public:
         ...
         ~Writer();
         void End();
         void Instruction(uint64_t addr, uint8_t size, uint8_t num_addresses, uint64_t addresses[], bool is_branch, bool taken, bool is_predicate, bool executed, uint64_t dstval, int dstsize, uint64_t bbhead);
